...
async function deleteCart() {
    const cartId = localStorage.getItem("cartId"); // Retrieve the cart ID dynamically
    const response = await fetch(`https://dummyjson.com/carts/${cartId}`, { method: "DELETE" });
    ...
    if (response.ok) { // Check if the response status is OK
        ...
        // You may want to clear the cart display here
    } else {
