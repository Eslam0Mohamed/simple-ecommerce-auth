...
let cartID = localStorage.setItem("cartId")

//    let productAdded = productsData.pro/ducts[index]
//    let productDetails = {
//     id:productAdded.id,
//     quantity:1
//    }
...
console.log(data);
productAddedToCart.push(data)
localStorage.setItem("productsList",JSON.stringify(productAddedToCart))
