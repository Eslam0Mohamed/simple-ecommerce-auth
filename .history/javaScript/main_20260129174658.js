...
function displaydProducts(productsData) {
    ...
    for (var product in productsData) {
        productsContainer += `
                            ...
                            <img src="${productsDataproduct.images[0]}" alt="product image" class="product-image">
                        <div class="text-container">
                            <h3 class="proudct-name">${productsDataproduct.title}</h3>
                            <span class="product-price">${productsDataproduct.price}</span>
                            <button class="add-to-cart-button" onclick="addToCart(${productsDataproduct})">Add To Cart</button>
                        </div>
                    </div>
