...
function displaydProducts(productsData) {
    ...
    for (var product in productsData) {
        productsContainer += `
                            ...
                            <img src="${proproduct.images[0]}" alt="product image" class="product-image">
                        <div class="text-container">
                            <h3 class="proudct-name">${proproduct.title}</h3>
                            <span class="product-price">${proproduct.price}</span>
                            <button class="add-to-cart-button" onclick="addToCart(${proproduct})">Add To Cart</button>
                        </div>
                    </div>
